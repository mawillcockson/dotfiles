...
export def "package-data-load-data" [] {
    ...
    simple-add "fd" {"windows": {"scoop": "fd"}} --tags ['essential', 'small'] --search-help ['find', 'rust'] |
    ...
    simple-add "imageglass" {"windows": {"scoop": "imageglass"}} --tags ['rarely'] --reasons ['nicer image viewer', 'can display and convert iPhone .avif images for free'] --search-help ['avif', 'av1', 'iPhone', 'picture'] |
    ...
    simple-add "picard" {"windows": {"scoop": "picard"}} --tags ['large', 'rarely', 'music'] --reasons ['makes organizing and tagging songs, and wrangling metadata, much easier'] --search-help ['musicbrainz'] |
    ...
    simple-add "ripgrep" {"windows": {"scoop": "ripgrep"}} --tags ['small', 'essential'] --reasons ['cross-platform, faster grep'] --search-help ['rg'] |
    ...
    simple-add "xonsh" {"windows": {"pipx": "xonsh"}} --tags ['python', 'shell', 'environment', 'rarely'] --reasons ['beloved cross-platform shell; extremely friendly to python'] |
    ...
    simple-add "exiv2" {"linux": {"apt-get": "exiv2"}} --tags ['small'] --reasons ['my favorite tool for reading and manipulating EXIF data in images'] --search-help ['picture'] |
    simple-add "exiftool" {"windows": {"scoop": "exiftool", "winget": "exiftool"}, "linux": {"apt-get": "exiftool"}} --tags ['small'] --reasons ['popular EXIF image metadata manipulation program'] --search-help ['picture'] |
    ...
    simple-add "nvr" {"windows": {"pipx": "neovim-remote"}} --tags [
