...
export def generate [] {
    ...
    add "nvm" {"windows": {"scoop": 'nvm'}} --tags ['javascript', 'tooling', 'rarely'] --reasons ['helps install various js-based tooling', 'nvm4win may be deprecated soon in favor of Runtime'] --links ['https://github.com/coreybutler/nvm-windows/discussions/565#discussioncomment-58112', 'https://github.com/nvm-sh/nvm'] |
    add "fnm" {"windows": {"scoop": 'fnm'}} --tags ['javascript', 'tooling', 'rarely'] --reasons ['cross-platform node version manager'] --links ['https://github.com/Schniz/fnm'] |
    add 'node' {'windows': {'custom': {||
                # use package/install.nu [main]
                # main 'fnm'
                ^fnm install --lts
