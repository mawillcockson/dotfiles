...
export def "package-data-load-data" [] {
    ...
    simple-add "kanata" {"windows": {"eget": "jtroo/kanata"}} --tags [small, keyboard, essential] --reasons ["does keyboard mapping like swapping CapsLock and Control in software"] --links ["https://github.com/jtroo/kanata"] |
    validate-data
}
